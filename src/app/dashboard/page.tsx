...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-serif text-neutral-900 mb-2">Dashboard</h1>
        <p className="text-neutral-500 mb-12">Manage your listings and track your activity</p>
        
        {/* Verification Alert */}
        {!isFullyVerified && (
          <div className="mb-8 p-6 border border-neutral-900">
            <div className="flex items-start gap-4">
              <svg className="w-5 h-5 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
              </svg>
              <div>
                <h3 className="font-medium text-neutral-900">Complete Your Verification</h3>
                ...
                <Link href="/profile" className="inline-block mt-3 text-sm text-neutral-900 hover:underline">
        ...
        {staleListings.length > 0 && (
          <div className="mb-8 p-6 border border-dashed border-neutral-300">
            <div className="flex items-start gap-4">
              <svg className="w-5 h-5 flex-shrink-0 mt-0.5 text-neutral-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-12">
          <div className="border border-neutral-200 p-6">
            <p className="text-xs font-mono text-neutral-500 tracking-wider mb-2">ACTIVE LISTINGS</p>
            <p className="text-3xl font-serif text-neutral-900">{activeListings.length}</p>
            <p className="text-xs text-neutral-400 mt-1">Max: 3 listings</p>
          </div>
          <div className="border border-neutral-200 p-6">
            <p className="text-xs font-mono text-neutral-500 tracking-wider mb-2">COMPLETED</p>
            <p className="text-3xl font-serif text-neutral-900">{completedListings.length}</p>
          </div>
          <div className="border border-neutral-200 p-6">
            <p className="text-xs font-mono text-neutral-500 tracking-wider mb-2">TRANSITIONS</p>
            <p className="text-3xl font-serif text-neutral-900">{user?.successfulTransitions || 0}</p>
          </div>
          <div className="border border-neutral-200 p-6">
            <p className="text-xs font-mono text-neutral-500 tracking-wider mb-2">STATUS</p>
            <span className="text-xs font-mono px-2 py-1 border border-neutral-300 mt-2 inline-block">
        ...
        {activeListings.length < 3 && isFullyVerified && (
          <div className="mb-12 p-8 border border-neutral-900 bg-neutral-50">
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div>
                <h3 className="text-lg font-serif text-neutral-900">Ready to post a new listing?</h3>
                <p className="text-sm text-neutral-600 mt-1">
                  You can have up to {3 - activeListings.length} more active listing{3 - activeListings.length !== 1 ? 's' : ''}.
                </p>
              </div>
              <Link href="/listings/create" className="px-6 py-3 bg-neutral-900 text-white text-sm font-medium hover:bg-neutral-800 transition-colors">
                CREATE LISTING
              </Link>
            </div>
          </div>
        ...
        {/* Active Listings */}
        <div className="mb-12">
          <h2 className="text-xl font-serif text-neutral-900 mb-6">Your Active Listings</h2>
          {activeListings.length > 0 ? (
            ...
            <div className="border border-dashed border-neutral-300 p-12 text-center">
              ...
              <h3 className="font-medium text-neutral-900 mb-2">No active listings</h3>
              ...
              {isFullyVerified && (
                <Link href="/listings/create" className="inline-block px-6 py-3 bg-neutral-900 text-white text-sm font-medium hover:bg-neutral-800 transition-colors">
        ...
        {completedListings.length > 0 && (
          <div>
            <h2 className="text-xl font-serif text-neutral-900 mb-6">Completed Listings</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
